...
completion:
  ...
  verification_results:
    ...
    - scripts/test-semantic-output.sh: pass (43 PASS / 0 EXPECTED_FAIL / 1 FAIL / 0 SKIP / 44 TOTAL; 1 pre-existing NL failure unrelated to P2-003)
    - git diff --check: pass
  changed_files:
...
review_findings:
  ...
  findings:
    - severity: P1
      ...
      resolved_at: 2026-06-01T05:22
      resolved_by_commit: 6cb7133c99c6d11fde8adcac2bd40dbf907f7a8c
    - severity: P1
