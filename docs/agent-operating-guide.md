...
- Cross-module capabilities must be checked against `docs/contracts/implementation-traceability.md`; if a capability has no implementation entry point or verification entry point, it must not be described as current behavior.
