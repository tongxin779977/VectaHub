...
function getAutoDetectCli() {
    return vscode.workspace.getConfiguration('vectahubTasks').get('autoDetectCli', true);
}
function getExecutionMode() {
    return vscode.workspace.getConfiguration('vectahubTasks').get('executionMode', 'strict');
}
