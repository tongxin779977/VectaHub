...
exports.registerRunCheckPipelineCommand = registerRunCheckPipelineCommand;
...
function registerRunCheckPipelineCommand(context, tasksProvider) {
    const disposable = vscode.commands.registerCommand('vectahubTasks.runCheckPipeline', async () => {
        ...
        const result = (0, devPipeline_js_1.createCheckPipeline)(tasks);
...
//# sourceMappingURL=runCheckPipeline.js.map